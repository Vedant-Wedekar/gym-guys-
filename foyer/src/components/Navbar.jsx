...
export default function Navbar() {
  ...
  return (
    <>
      <motion.div
        className="fixed inset-x-0 top-0 z-[70] h-[3px] origin-left bg-gradient-to-r from-champagne via-emerald-mid to-royal-mid"
      ...
      >
        ...
        >
          <a href="#top" className="flex items-center gap-2 font-display text-xl tracking-[0.16em] md:text-2xl">
            <span className="text-champagne">✦</span>FOYER
          </a>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            className="wash-sand fixed inset-0 z-[80] flex flex-col"
