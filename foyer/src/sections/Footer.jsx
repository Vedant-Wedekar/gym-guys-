...
const cols = [
  { icon: HiOutlineLocationMarker, title: 'Cities', lines: FOOTER.address },
...
export default function Footer() {
  return (
    <footer id="contact" className="curve-top relative overflow-hidden bg-ink text-ivory">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr]">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display display-tight text-4xl sm:text-5xl md:text-6xl">
              Your evenings are
              <br />
              <span className="italic text-champagne">yours again.</span>
            </h2>
            <Magnetic>
              <a
                href="mailto:hello@foyer.homes?subject=My%20first%20FOYER%20booking"
        ...
        <FadeUp delay={0.2}>
          <div className="mt-14 flex flex-wrap items-center justify-between gap-6 border-t border-ivory/12 pt-8">
            ...
            <div className="flex gap-3">
              {[FaInstagram, FaPinterestP, FaWhatsapp].map((Icon, i) => (
      ...
      <div className="border-t border-ivory/8 py-6 opacity-12">
        <Marquee speed={46}>
          <span className="mx-6 font-display text-[18vw] leading-none tracking-wider md:text-[10vw]">
            FOYER · HOME · BEAUTIFULLY KEPT ·&nbsp;
          </span>
        </Marquee>
      </div>

      <p className="px-5 pb-6 text-center text-xs text-ivory/35 md:px-8">
        © {new Date().getFullYear()} FOYER — Home Services. Every booking pays helpers
        above-market rates.
      </p>
    </footer>
  )
