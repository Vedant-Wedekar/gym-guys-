    ...
    <section className="relative bg-ivory px-5 pb-20 md:px-8 md:pb-28">
      <FadeUp>
        <div className="grad-animated relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] px-6 py-16 text-center md:rounded-[3.5rem] md:px-12 md:py-24">
          ...
          <h2 className="mx-auto mt-4 max-w-2xl font-display display-tight text-4xl font-medium sm:text-5xl md:text-6xl">
            The Sunday <span className="italic grad-text-emerald">Reset</span>
          </h2>
            ...
            <AnimatePresence mode="wait">
              {sent ? (
                ...
                >
                  ...
                  Welcome in — your first Reset arrives Sunday.
                </motion.div>
              ) : (
                <motion.div
                  key="form"
