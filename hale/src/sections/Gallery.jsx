    ...
    <section id="gallery" className="relative bg-ivory pb-20 pt-20 md:pb-28 md:pt-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            <Eyebrow className="text-ink/65">Nº 04 — Healthy Living</Eyebrow>
            <FadeUp delay={0.1}>
              <h2 className="mt-5 font-display display-tight text-4xl font-medium sm:text-5xl md:text-6xl">
                Life, at a
                <br />
                <span className="italic text-stroke">walking pace.</span>
              </h2>
            </FadeUp>
          </div>
          <FadeUp delay={0.2}>
            <p className="max-w-sm text-sm leading-relaxed text-stone md:text-base">
              Mornings on the mat, bowls worth photographing, hills worth climbing — daily life at
              the hub.
            </p>
          </FadeUp>
        </div>
