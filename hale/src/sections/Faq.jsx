        ...
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <FadeUp delay={0.1}>
            <h2 className="mt-5 font-display display-tight text-4xl font-medium sm:text-5xl md:text-6xl">
              Before your
              <br />
              <span className="italic grad-text-emerald">first visit.</span>
            </h2>
          </FadeUp>
          <FadeUp delay={0.2}>
            <p className="mt-6 max-w-sm leading-relaxed text-stone">
              ...
              <a
                href="mailto:hello@hale.health"
                className="border-b border-emerald-mid text-ink transition-colors hover:text-emerald-deep"
              >
                hello@hale.health
              </a>{' '}
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      className={`grid h-9 w-9 shrink-0 place-items-center rounded-full border transition-colors ${
                        isOpen
                          ? 'border-emerald-mid bg-emerald-mid text-ivory'
